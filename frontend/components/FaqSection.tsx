...
export default function FaqSection({
  ...
  // Dynamically hydrate from live CMS API
  useEffect(() => {
    let isMounted = true;
    if (pageKey) {
          ...
          <div className="lg:col-span-5 xl:col-span-4 lg:sticky lg:top-28 space-y-6 mb-10 lg:mb-0">
            ...
            <div className="rounded-2xl p-5 sm:p-6 bg-white border border-slate-200/90 shadow-[0_4px_24px_rgba(15,23,42,0.05)] relative overflow-hidden group">
              ...
              <div className="pt-3 space-y-2">
                <a
                  href="tel:+9779851016629"
                  className="flex items-center justify-between px-3.5 py-2 rounded-xl bg-slate-50 hover:bg-blue-50/60 border border-slate-200/70 text-xs font-semibold text-[#1b3a6e] transition-colors"
                >
                  ...
                  <span className="text-[10px] text-slate-400 uppercase tracking-wider font-bold">Call</span>
                </a>
