      ...
      <div className="max-w-[1280px] mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-white/5 border border-emerald-500/30 text-emerald-400 rounded text-xs font-semibold mb-3">
